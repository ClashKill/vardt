 ...
 */
(function ($) {
    wp.customize('exalt_entries_layout', function (value) {
        value.bind(function (newVal) {
            if (newVal === 'grid') {
                wp.customize.control('exalt_archive_thumbnail_position').setting.set('before-header');
            } else {
                wp.customize.control('exalt_archive_thumbnail_position').setting.set('beside-article');
            }
        });
    });
})(jQuery);
